/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./wrangler.d.ts` (hash: 3f0dd5e38aa28ee8f334e95b16590b9c)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	CUTTLE_PUBLIC_ORIGIN: "https://your-domain.example";
	CUTTLE_LINK_KEY: string;
	CUTTLE_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CUTTLE_PUBLIC_ORIGIN" | "CUTTLE_LINK_KEY" | "CUTTLE_TOKEN">> {}
}
